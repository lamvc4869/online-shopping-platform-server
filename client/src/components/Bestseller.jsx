...
const Bestseller = () => {
  ...
  // Lấy top 5 sản phẩm bán chạy từ API
    ...
    return (
      <div className="py-12 px-6 md:px-16 lg:px-24 xl:px-32 bg-gradient-to-br from-green-50/40 via-white to-emerald-50/30">
        ...
        <div className="text-center py-20">
          ...
          <p className="text-gray-500">Vui lòng đăng nhập để xem sản phẩm</p>
        </div>
      </div>
    );
  }
    ...
    <div className="py-12 px-6 md:px-16 lg:px-24 xl:px-32 bg-gradient-to-br from-green-50/40 via-white to-emerald-50/30">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
          Top {bestsellerProducts.length} products loved by thousands of
          customers
        </p>
      </div>
          ...
          {bestsellerProducts.map((product, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-3">
                  <div className="mb-2">
                    <p className="text-green-600 text-[10px] font-semibold uppercase tracking-wide">
                      {product.category}
                    </p>
                  ...
                  <div className="flex items-center gap-0.5 mb-2">
                    ...
                    <span className="text-gray-600 text-[10px] ml-0.5 font-medium">
                      (4.0)
                    </span>
                  </div>
